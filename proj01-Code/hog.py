...
def is_always_roll(strategy, goal=GOAL_SCORE):
    ...
    """
    # BEGIN PROBLEM 7
    if strategy is always_roll_5 or callable(strategy) and strategy.__name__ == 'consistent_roll':
        return True
...
def swine_strategy(score, opponent_score, threshold=8, num_rolls=6):
    ...
    """
    # BEGIN PROBLEM 11
    p = picky_piggy(opponent_score)
    ns = score + p
    if p >= threshold and not swine_swap(ns):
        return 0
    elif swine_swap(ns) and (opponent_score - score) > threshold:
        return 0
    else:
        return num_rolls
    # END PROBLEM 11
...
def final_strategy(score, opponent_score):
    ...
    *** YOUR DESCRIPTION HERE ***
    ...
    if score > opponent_score:
        ...
        return picky_strategy(score, opponent_score)
    # END PROBLEM 12
